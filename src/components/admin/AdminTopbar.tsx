    ...
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-white">
      <div className="flex h-20 items-center justify-between gap-4 px-5 lg:px-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-500">Administrator Workspace</p>
            <p className="font-bold text-slate-900">System Control Centre</p>
          </div>
        </div>
        ...
        <div className="hidden max-w-md flex-1 md:block">
          <div className="relative">
            ...
            <input
              type="search"
              placeholder="Search users, roles or system records..."
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            className="flex items-center gap-3 rounded-lg border border-slate-200 px-3 py-2 transition hover:bg-slate-50"
          >
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-blue-100 font-bold text-blue-700">SA</div>
